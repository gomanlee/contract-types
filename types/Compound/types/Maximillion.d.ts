...
export interface Maximillion extends BaseContract {
    ...
    functions: {
        ...
        repayBehalf(borrower: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        repayBehalfExplicit(borrower: string, cEther_: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    cEther(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        repayBehalfExplicit(borrower: string, cEther_: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
