...
export interface EnumerableBytes32SetMock extends BaseContract {
    ...
    functions: {
        add(value: BytesLike, overrides?: Overrides & {
        ...
        remove(value: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    populateTransaction: {
        ...
        contains(value: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
