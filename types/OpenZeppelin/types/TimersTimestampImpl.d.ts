...
export interface TimersTimestampImplInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "getDeadline", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getDeadline", data: BytesLike): Result;
...
export interface TimersTimestampImpl extends BaseContract {
    ...
    functions: {
        ...
        setDeadline(timestamp: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    getDeadline(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    callStatic: {
        ...
        setDeadline(timestamp: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        getDeadline(overrides?: CallOverrides): Promise<BigNumber>;
