...
export declare type TokensReceivedCalledEvent = TypedEvent<[
    string,
    string,
    string,
    BigNumber,
...
export declare type TokensReceivedCalledEventFilter = TypedEventFilter<TokensReceivedCalledEvent>;
export declare type TokensToSendCalledEvent = TypedEvent<[
    string,
    string,
    string,
    BigNumber,
...
export declare type TokensToSendCalledEventFilter = TypedEventFilter<TokensToSendCalledEvent>;
