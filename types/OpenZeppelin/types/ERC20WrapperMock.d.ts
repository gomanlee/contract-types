...
export interface ERC20WrapperMock extends BaseContract {
    ...
    functions: {
        ...
        depositFor(account: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        recover(account: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        underlying(overrides?: CallOverrides): Promise<string>;
        withdrawTo(account: string, amount: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
