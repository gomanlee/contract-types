...
export interface IERC1363Receiver extends BaseContract {
    ...
    functions: {
        onTransferReceived(operator: string, from: string, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
    ...
    callStatic: {
        onTransferReceived(operator: string, from: string, value: BigNumberish, data: BytesLike, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
        onTransferReceived(operator: string, from: string, value: BigNumberish, data: BytesLike, overrides?: Overrides & {
