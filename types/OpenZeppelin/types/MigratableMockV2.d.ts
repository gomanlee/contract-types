...
export interface MigratableMockV2 extends BaseContract {
    ...
    functions: {
        ...
        migrate(value: BigNumberish, anotherValue: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        migrate(value: BigNumberish, anotherValue: BigNumberish, overrides?: CallOverrides): Promise<void>;
        x(overrides?: CallOverrides): Promise<BigNumber>;
        y(overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {};
