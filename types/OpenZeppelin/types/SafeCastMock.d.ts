...
export interface SafeCastMockInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "toInt16", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toInt256", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toInt32", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toInt64", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toInt8", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint128", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint16", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint224", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint256", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint32", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint64", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint8", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "toUint96", values: [BigNumberish]): string;
...
export interface SafeCastMock extends BaseContract {
    ...
    populateTransaction: {
        toInt128(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toInt16(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toInt256(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toInt32(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toInt64(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toInt8(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint128(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint16(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint224(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint256(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint32(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint64(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint8(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        toUint96(a: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
