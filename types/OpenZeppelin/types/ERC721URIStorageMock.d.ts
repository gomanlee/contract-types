...
export interface ERC721URIStorageMockInterface extends utils.Interface {
    contractName: "ERC721URIStorageMock";
    functions: {
...
export interface ERC721URIStorageMock extends BaseContract {
    ...
    functions: {
        ...
        setBaseURI(newBaseTokenURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setTokenURI(tokenId: BigNumberish, _tokenURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setBaseURI(newBaseTokenURI: string, overrides?: CallOverrides): Promise<void>;
        setTokenURI(tokenId: BigNumberish, _tokenURI: string, overrides?: CallOverrides): Promise<void>;
        supportsInterface(interfaceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        symbol(overrides?: CallOverrides): Promise<string>;
        tokenURI(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
