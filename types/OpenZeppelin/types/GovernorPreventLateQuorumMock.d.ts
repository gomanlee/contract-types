...
export interface GovernorPreventLateQuorumMockInterface extends utils.Interface {
...
export declare type LateQuorumVoteExtensionSetEvent = TypedEvent<[
    BigNumber,
    BigNumber
], {
...
export declare type LateQuorumVoteExtensionSetEventFilter = TypedEventFilter<LateQuorumVoteExtensionSetEvent>;
...
export declare type ProposalExtendedEvent = TypedEvent<[
    BigNumber,
    BigNumber
], {
    proposalId: BigNumber;
...
export declare type ProposalExtendedEventFilter = TypedEventFilter<ProposalExtendedEvent>;
