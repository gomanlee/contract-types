...
export interface ERC721RoyaltyMockInterface extends utils.Interface {
    contractName: "ERC721RoyaltyMock";
    functions: {
    ...
    encodeFunctionData(functionFragment: "deleteDefaultRoyalty", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "setTokenRoyalty", values: [BigNumberish, string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "deleteDefaultRoyalty", data: BytesLike): Result;
...
export interface ERC721RoyaltyMock extends BaseContract {
    ...
    functions: {
        ...
        deleteDefaultRoyalty(overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setDefaultRoyalty(recipient: string, fraction: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setTokenRoyalty(tokenId: BigNumberish, recipient: string, fraction: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setDefaultRoyalty(recipient: string, fraction: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setTokenRoyalty(tokenId: BigNumberish, recipient: string, fraction: BigNumberish, overrides?: CallOverrides): Promise<void>;
        supportsInterface(interfaceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        symbol(overrides?: CallOverrides): Promise<string>;
        tokenURI(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
