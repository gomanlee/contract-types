...
export interface GovernorTimelockCompoundMockInterface extends utils.Interface {
    contractName: "GovernorTimelockCompoundMock";
    functions: {
...
export interface GovernorTimelockCompoundMock extends BaseContract {
    ...
    functions: {
        ...
        cancel(targets: string[], values: BigNumberish[], calldatas: BytesLike[], salt: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        cancel(targets: string[], values: BigNumberish[], calldatas: BytesLike[], salt: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
