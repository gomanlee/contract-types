...
export interface MigratableMockV3 extends BaseContract {
    ...
    functions: {
        ...
        "migrate(uint256,uint256)"(value: BigNumberish, anotherValue: BigNumberish, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "migrate()"(overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "migrate(uint256,uint256)"(value: BigNumberish, anotherValue: BigNumberish, overrides?: CallOverrides): Promise<void>;
