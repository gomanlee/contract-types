...
interface ChainlinkTruUsdcOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainlinkTruUsdcOracle extends Contract {
  ...
  interface: ChainlinkTruUsdcOracleInterface;
