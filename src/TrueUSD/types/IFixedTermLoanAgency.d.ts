...
interface IFixedTermLoanAgencyInterface extends ethers.utils.Interface {
  functions: {
...
export class IFixedTermLoanAgency extends Contract {
  ...
  interface: IFixedTermLoanAgencyInterface;
