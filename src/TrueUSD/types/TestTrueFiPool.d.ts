...
interface TestTrueFiPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "superBorrow(uint256,uint256)": FunctionFragment;
...
export class TestTrueFiPool extends Contract {
  ...
  interface: TestTrueFiPoolInterface;
