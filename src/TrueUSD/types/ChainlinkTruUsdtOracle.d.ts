...
interface ChainlinkTruUsdtOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainlinkTruUsdtOracle extends Contract {
  ...
  interface: ChainlinkTruUsdtOracleInterface;
