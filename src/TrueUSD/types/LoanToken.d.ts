...
interface LoanTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lastMinutePaybackDuration()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lastMinutePaybackDuration",
    values?: undefined
  ): string;
...
export class LoanToken extends Contract {
  ...
  functions: {
    ...
    lastMinutePaybackDuration(overrides?: CallOverrides): Promise<[BigNumber]>;
