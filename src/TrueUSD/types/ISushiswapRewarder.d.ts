...
interface ISushiswapRewarderInterface extends ethers.utils.Interface {
  functions: {
...
export class ISushiswapRewarder extends Contract {
  ...
  interface: ISushiswapRewarderInterface;
