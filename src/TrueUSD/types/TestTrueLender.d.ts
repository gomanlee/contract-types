...
interface TestTrueLenderInterface extends ethers.utils.Interface {
  functions: {
    ...
    "testDistribute(address,uint256,uint256,address)": FunctionFragment;
    "testTransferAllLoanTokens(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testTransferAllLoanTokens",
...
export class TestTrueLender extends Contract {
  ...
  interface: TestTrueLenderInterface;
  ...
  functions: {
    ...
    "testDistribute(address,uint256,uint256,address)"(
      recipient: string,
      numerator: BigNumberish,
      denominator: BigNumberish,
      pool: string,
    ...
    testTransferAllLoanTokens(
      loan: string,
      recipient: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "testTransferAllLoanTokens(address,address)"(
      loan: string,
      recipient: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
