...
interface TestLegacyLoanToken2Interface extends ethers.utils.Interface {
  functions: {
    "LAST_MINUTE_PAYBACK_DURATION()": FunctionFragment;
    "admin()": FunctionFragment;
    "allowAllTransfers(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "allowAllTransfers",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "TransferabilityChanged(bool)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "TransferabilityChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Withdrawn"): EventFragment;
}

export class TestLegacyLoanToken2 extends Contract {
  ...
  interface: TestLegacyLoanToken2Interface;
