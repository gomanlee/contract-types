...
interface TrueRatingAgencyV2Interface extends ethers.utils.Interface {
  functions: {
...
export class TrueRatingAgencyV2 extends Contract {
  ...
  interface: TrueRatingAgencyV2Interface;
