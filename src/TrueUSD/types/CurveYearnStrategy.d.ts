...
interface CurveYearnStrategyInterface extends ethers.utils.Interface {
  functions: {
...
export class CurveYearnStrategy extends Contract {
  ...
  interface: CurveYearnStrategyInterface;
