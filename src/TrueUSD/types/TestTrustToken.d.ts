...
interface TestTrustTokenInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "getStamp", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "getStamp", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "increaseAllowance",
    data: BytesLike
  ): Result;
...
export class TestTrustToken extends Contract {
  ...
  interface: TestTrustTokenInterface;
  ...
  functions: {
    ...
    getStamp(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { stamp: BigNumber }>;
  ...
  getStamp(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getStamp(overrides?: CallOverrides): Promise<PopulatedTransaction>;
