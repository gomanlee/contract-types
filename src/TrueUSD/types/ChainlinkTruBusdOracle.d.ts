...
interface ChainlinkTruBusdOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainlinkTruBusdOracle extends Contract {
  ...
  interface: ChainlinkTruBusdOracleInterface;
