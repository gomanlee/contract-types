...
interface MockTrueFiPoolOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class MockTrueFiPoolOracle extends Contract {
  ...
  interface: MockTrueFiPoolOracleInterface;
