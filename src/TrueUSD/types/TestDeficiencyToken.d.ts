...
interface TestDeficiencyTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class TestDeficiencyToken extends Contract {
  ...
  interface: TestDeficiencyTokenInterface;
