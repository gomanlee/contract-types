...
interface RatingAgencyV2DistributorInterface extends ethers.utils.Interface {
  functions: {
...
export class RatingAgencyV2Distributor extends Contract {
  ...
  interface: RatingAgencyV2DistributorInterface;
