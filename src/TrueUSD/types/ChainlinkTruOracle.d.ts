...
interface ChainlinkTruOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainlinkTruOracle extends Contract {
  ...
  interface: ChainlinkTruOracleInterface;
