...
interface ITrueFiPoolOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class ITrueFiPoolOracle extends Contract {
  ...
  interface: ITrueFiPoolOracleInterface;
